...
import { FileText, Trash2, Eye, Clock, ChevronRight, ImageIcon } from 'lucide-react'
      ...
      <div className={styles.header}>
        <div>
          ...
          <p className={styles.sub}>
            {history.length} extraction{history.length !== 1 ? 's' : ''} stored locally
          </p>
        </div>
        {history.length > 0 && (
              ...
              >
                ...
                <div className={styles.cardBody}>
                  <div className={styles.cardNameRow}>
                    <span className={styles.cardName}>{item.filename}</span>
                    {item.hasPreview && (
                  ...
                  <div className={styles.cardMeta}>
                    ...
                    {item.data?.vendor_name && (
                      <span className={styles.vendor}>{item.data.vendor_name}</span>
                    )}
                  </div>
                </div>
